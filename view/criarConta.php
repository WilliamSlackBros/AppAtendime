...
<main class="col-8 jumbotron text-center jumbotron-main" style="margin-left:auto;margin-right:auto;margin-top:10px; margin-bottom:0;">
  <div class="painelLogin">
    <form>
    <div class="form-group"  >
      <label for="exampleInputNome">Nome</label>
      <input type="email" class="form-control is-valid" id="exampleInputNome" aria-describedby="emailHelp" placeholder="Entrer com primeiro nome" >
      <label for="exampleInputNome">Sobrenome</label>
      <input type="email" class="form-control is-valid" id="exampleInputNome" aria-describedby="emailHelp" placeholder="Entrer com sobrenome" >
      <div class="ui divider"></div>
      <label for="exampleInputEmail1">E-mail</label>
      <div class="ui"  data-tooltip="A senha deve conter no mínimo 8 caracteres" data-position="right center" >
      <input type="email" class="form-control is-valid" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrer com e-mail" >
      </div>
      <!--
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control  is-invalid" id="exampleInputPassword1" placeholder="Redigite a senha">
<!--
      <div class="valid-feedback">
        Looks good!
      </div>
  ...
  <div class="ui divider"></div>
   ...
   <div class="form-group">
    <button type="submit" class="btn btn-outline-primary  btn-block btn-sm" style="color:white;">Criar</button>
