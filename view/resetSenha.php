...
<main class="col-8 jumbotron text-center jumbotron-main" style="margin-left:auto;margin-right:auto;margin-top:20px; margin-bottom:0;">
  <div class="painelLogin">
    ...
    <div class="form-group"  >
      ...
      <input type="email" class="form-control is-valid" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Código enviará para e-mail" >
      </div>
    </br>
      <button type="submit" class="btn btn-outline-primary  btn-block btn-sm" style="color:white;">Enviar</button>
      <div class="ui divider"></div>
      <div class="form-group">
       <input type="email" class="form-control is-valid" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Código!" >
     </div>
    </div>
    <div class="ui divider"></div>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control  is-invalid" id="exampleInputPassword1" placeholder="Repita a senha">
  </div>
  <div class="ui divider"></div>
   <div class="form-group">
    <button type="submit" class="btn btn-outline-primary  btn-block btn-sm" style="color:white;">Salvar</button>
